...
test("Polygon#clone", function (t) {
  t.plan(2);
  var p1 = new Polygon([[12, 18], [14, 31], [19, 32], [22, 24]]);
  var p2 = p1.clone();
...
test("Polygon#contains", function (t) {
  t.plan(2);
  var p1 = new Polygon([[10, 10], [10, 20], [20, 20], [20, 10]]);
...
test("Polygon#getCentroid", function (t) {
  t.plan(2);
  var p1 = new Polygon([[10, 10], [10, 30], [20, 30], [20, 10]]);
...
test("Polygon#round", function (t) {
  ...
  var p0 = new Polygon([[10, 10], [10, 20], [20, 20], [20, 10]]);

  var p1 = new Polygon([[9.5, 9.6], [10.4, 20.3], [19.7, 19.6], [20.333, 9.7]]);
...
test("Polygon#moveBy", function (t) {
  ...
  var p0 = new Polygon([[15, 11], [15, 21], [25, 21], [25, 11]]);
